...
const Footer = () => {
  return (
    <div className="sticky mt-6 top-[100vh]">
      <footer className="grid grid-cols-2 bg-neutral text-neutral-content ">
        <div className="w-full mx-auto bg-[#1F2937] flex flex-col justify-center items-center p-24 gap-4">
        ...
        <div className="flex flex-col gap-4 items-center justify-center w-full p-24 bg-[#111827]">
          <h6 className="footer-title font-medium text-3xl text-white">
            Follow Us
          </h6>
          <p className="text-center font-medium text-xl text-white ">
